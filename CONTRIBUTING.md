Contributing to Stakinglab Core
============================

The Stakinglab Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the labx unit tests or QA tests
...
The following applies to code changes to the Stakinglab Core project, and is not to be
confused with overall LABX Network Protocol consensus changes.

Whether a pull request is merged into Stakinglab Core rests with the project merge
...
Patches that change LABX consensus rules are considerably more involved than
...
Where a patch set proposes to change the LABX consensus, it must have been
...
The project leader is the release manager for each Stakinglab Core release.
