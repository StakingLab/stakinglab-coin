...
Setup
---------
Configuring the github-merge tool for the LABX repository is done in the following way:

    git config githubmerge.repository LABX-Project/LABX
...
A script to optimize png files in the LABX
