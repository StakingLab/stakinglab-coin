...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LABX features */
        {"labx", "masternode", &masternode, true, true, false},
        {"labx", "listmasternodes", &listmasternodes, true, true, false},
        {"labx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"labx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"labx", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"labx", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"labx", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"labx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"labx", "masternodedebug", &masternodedebug, true, true, false},
        {"labx", "startmasternode", &startmasternode, true, true, false},
        {"labx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"labx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"labx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"labx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"labx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"labx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"labx", "mnbudget", &mnbudget, true, true, false},
        {"labx", "preparebudget", &preparebudget, true, true, false},
        {"labx", "submitbudget", &submitbudget, true, true, false},
        {"labx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"labx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"labx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"labx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"labx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"labx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"labx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"labx", "checkbudgets", &checkbudgets, true, true, false},
        {"labx", "mnsync", &mnsync, true, true, false},
        {"labx", "spork", &spork, true, true, false},
        {"labx", "getpoolinfo", &getpoolinfo, true, true, false},
