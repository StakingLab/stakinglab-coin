...
QT_MOC_LITERAL(8, 133, 32), // "anonymizeStakinglabAmountChanged"
...
QT_MOC_LITERAL(11, 217, 18) // "hideOrphansChanged"
    ...
    "anonymizeStakinglabAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->anonymizeStakinglabAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeStakinglabAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void OptionsModel::anonymizeStakinglabAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
