                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zLABX || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    if (context == Context::Send_LABX || context == Context::Send_zLABX) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("LABX will close now to finish the encryption process. "
