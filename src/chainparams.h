 ...
 * LABX system. There are three: the main network on which people trade goods
...
public:
    ...
    int MinimumStakingAmountV2BlockStart() const { return minimumStakingAmountV2BlockStart; }
...
protected:
    ...
    int minimumStakingAmountV2BlockStart;
