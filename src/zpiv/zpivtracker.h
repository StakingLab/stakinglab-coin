...
#ifndef LABX_ZLABXTRACKER_H
#define LABX_ZLABXTRACKER_H
...
public:
    CzLABXTracker(std::string strWalletFile);
    ~CzLABXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLABXWallet* zLABXWallet = NULL);
