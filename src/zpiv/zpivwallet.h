...
#ifndef LABX_ZLABXWALLET_H
#define LABX_ZLABXWALLET_H
...
public:
    CzLABXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLABX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLABX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
