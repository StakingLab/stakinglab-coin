...
Only requiring some minor changes is labx.cpp.
...
Changes to labx.cpp
----------------------
labx.cpp is the entry point into labx-qt, and as such, will require some minor modifications to provide hooks for
